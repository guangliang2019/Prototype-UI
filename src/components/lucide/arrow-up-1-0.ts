export default class LucideArrowUp10 extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-arrow-up-1-0');
...
customElements.define('lucide-arrow-up-1-0', LucideArrowUp10);
