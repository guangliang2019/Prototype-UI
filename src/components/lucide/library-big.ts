export default class LucideLibraryBig extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-library-big');
...
customElements.define('lucide-library-big', LucideLibraryBig);
