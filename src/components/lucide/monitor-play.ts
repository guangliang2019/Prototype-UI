export default class LucideMonitorPlay extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-monitor-play');
...
customElements.define('lucide-monitor-play', LucideMonitorPlay);
