export default class LucideChartColumnBig extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-chart-column-big');
...
customElements.define('lucide-chart-column-big', LucideChartColumnBig);
