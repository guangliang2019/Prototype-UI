export default class LucideBatteryLow extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-battery-low');
...
customElements.define('lucide-battery-low', LucideBatteryLow);
