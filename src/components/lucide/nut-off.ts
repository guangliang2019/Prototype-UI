export default class LucideNutOff extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-nut-off');
    ...
    path3.setAttribute('d', 'M19 10v3.343');
...
customElements.define('lucide-nut-off', LucideNutOff);
