export default class LucideKeySquare extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-key-square');
...
customElements.define('lucide-key-square', LucideKeySquare);
