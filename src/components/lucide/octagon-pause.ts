export default class LucideOctagonPause extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-octagon-pause');
    ...
    path1.setAttribute('d', 'M10 15V9');
    svg.appendChild(path1);

    const path2 = document.createElementNS('http://www.w3.org/2000/svg', 'path');
    path2.setAttribute('d', 'M14 15V9');
...
customElements.define('lucide-octagon-pause', LucideOctagonPause);
