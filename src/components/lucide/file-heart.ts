export default class LucideFileHeart extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-file-heart');
...
customElements.define('lucide-file-heart', LucideFileHeart);
