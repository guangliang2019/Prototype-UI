export default class LucideBotMessageSquare extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-bot-message-square');
...
customElements.define('lucide-bot-message-square', LucideBotMessageSquare);
