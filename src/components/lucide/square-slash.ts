export default class LucideSquareSlash extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-square-slash');
...
customElements.define('lucide-square-slash', LucideSquareSlash);
