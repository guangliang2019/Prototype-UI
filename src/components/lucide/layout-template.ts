export default class LucideLayoutTemplate extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-layout-template');
...
customElements.define('lucide-layout-template', LucideLayoutTemplate);
