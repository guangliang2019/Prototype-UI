export default class LucidePackageOpen extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-package-open');
    ...
    path1.setAttribute('d', 'M12 22v-9');
...
customElements.define('lucide-package-open', LucidePackageOpen);
