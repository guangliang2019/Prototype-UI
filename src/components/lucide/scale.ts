export default class LucideScale extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-scale');
    ...
    path5.setAttribute('d', 'M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2');
    svg.appendChild(path5);

    this.appendChild(svg);
  }
}
customElements.define('lucide-scale', LucideScale);
