export default class LucideBetweenVerticalStart extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-between-vertical-start');
    ...
    path1.setAttribute('d', 'm15 2-3 3-3-3');
...
customElements.define('lucide-between-vertical-start', LucideBetweenVerticalStart);
