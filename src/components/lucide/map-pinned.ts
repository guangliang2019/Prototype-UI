export default class LucideMapPinned extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-map-pinned');
...
customElements.define('lucide-map-pinned', LucideMapPinned);
