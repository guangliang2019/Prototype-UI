export default class LucideFilePenLine extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-file-pen-line');
...
customElements.define('lucide-file-pen-line', LucideFilePenLine);
