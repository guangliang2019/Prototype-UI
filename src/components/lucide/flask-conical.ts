export default class LucideFlaskConical extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-flask-conical');
...
customElements.define('lucide-flask-conical', LucideFlaskConical);
