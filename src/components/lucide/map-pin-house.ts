export default class LucideMapPinHouse extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-map-pin-house');
    ...
    path3.setAttribute('d', 'M18 22v-3');
...
customElements.define('lucide-map-pin-house', LucideMapPinHouse);
