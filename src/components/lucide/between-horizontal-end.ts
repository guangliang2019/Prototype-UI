export default class LucideBetweenHorizontalEnd extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-between-horizontal-end');
    ...
    path1.setAttribute('d', 'm22 15-3-3 3-3');
...
customElements.define('lucide-between-horizontal-end', LucideBetweenHorizontalEnd);
