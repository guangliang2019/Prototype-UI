export default class LucideMap extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-map');
    ...
    path2.setAttribute('d', 'M15 5.764v15');
    svg.appendChild(path2);

    const path3 = document.createElementNS('http://www.w3.org/2000/svg', 'path');
    path3.setAttribute('d', 'M9 3.236v15');
    svg.appendChild(path3);

    this.appendChild(svg);
  }
}
customElements.define('lucide-map', LucideMap);
