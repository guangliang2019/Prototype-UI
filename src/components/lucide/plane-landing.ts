export default class LucidePlaneLanding extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-plane-landing');
...
customElements.define('lucide-plane-landing', LucidePlaneLanding);
