export default class LucideLayoutPanelLeft extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-layout-panel-left');
...
customElements.define('lucide-layout-panel-left', LucideLayoutPanelLeft);
