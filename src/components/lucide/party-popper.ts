export default class LucidePartyPopper extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-party-popper');
    ...
    path8.setAttribute('d', 'm11 2 .33.82c.34.86-.2 1.82-1.11 1.98C9.52 4.9 9 5.52 9 6.23V7');
...
customElements.define('lucide-party-popper', LucidePartyPopper);
