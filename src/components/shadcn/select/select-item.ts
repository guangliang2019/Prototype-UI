...
import { asSelectItem, SelectContext, SelectItemExposes } from '@/core/behaviors/as-select';
...
export const ShadcnSelectItemPrototype = definePrototype<ShadcnSelectItemProps, SelectItemExposes>({
