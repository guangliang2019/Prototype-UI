export default class LucideBatteryFull extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-battery-full');
    ...
    line4.setAttribute('y2', '13');
    svg.appendChild(line4);

    this.appendChild(svg);
  }
}
customElements.define('lucide-battery-full', LucideBatteryFull);
