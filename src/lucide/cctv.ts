export default class LucideCctv extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-cctv');
    ...
    path3.setAttribute('d', 'M2 19h3.76a2 2 0 0 0 1.8-1.1L9 15');
    svg.appendChild(path3);

    const path4 = document.createElementNS('http://www.w3.org/2000/svg', 'path');
    path4.setAttribute('d', 'M2 21v-4');
...
customElements.define('lucide-cctv', LucideCctv);
