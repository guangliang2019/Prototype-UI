export default class LucideComponent extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-component');
...
customElements.define('lucide-component', LucideComponent);
