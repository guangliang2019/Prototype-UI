export default class LucideDumbbell extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-dumbbell');
    ...
    path1.setAttribute('d', 'M14.4 14.4 9.6 9.6');
    ...
    path3.setAttribute('d', 'm21.5 21.5-1.4-1.4');
    svg.appendChild(path3);

    const path4 = document.createElementNS('http://www.w3.org/2000/svg', 'path');
    path4.setAttribute('d', 'M3.9 3.9 2.5 2.5');
...
customElements.define('lucide-dumbbell', LucideDumbbell);
