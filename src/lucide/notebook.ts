export default class LucideNotebook extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-notebook');
    ...
    path5.setAttribute('d', 'M16 2v20');
    svg.appendChild(path5);

    this.appendChild(svg);
  }
}
customElements.define('lucide-notebook', LucideNotebook);
