export default class LucideLocateFixed extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-locate-fixed');
...
customElements.define('lucide-locate-fixed', LucideLocateFixed);
