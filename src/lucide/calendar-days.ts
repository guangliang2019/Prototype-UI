export default class LucideCalendarDays extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-calendar-days');
...
customElements.define('lucide-calendar-days', LucideCalendarDays);
