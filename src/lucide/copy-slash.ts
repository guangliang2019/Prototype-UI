export default class LucideCopySlash extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-copy-slash');
...
customElements.define('lucide-copy-slash', LucideCopySlash);
