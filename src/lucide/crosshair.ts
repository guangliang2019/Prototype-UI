export default class LucideCrosshair extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-crosshair');
...
customElements.define('lucide-crosshair', LucideCrosshair);
