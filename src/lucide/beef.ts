export default class LucideBeef extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-beef');
    ...
    circle1.setAttribute('cx', '12.5');
    circle1.setAttribute('cy', '8.5');
...
customElements.define('lucide-beef', LucideBeef);
