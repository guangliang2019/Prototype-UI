export default class LucidePickaxe extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-pickaxe');
    ...
    path1.setAttribute('d', 'M14.531 12.469 6.619 20.38a1 1 0 1 1-3-3l7.912-7.912');
...
customElements.define('lucide-pickaxe', LucidePickaxe);
