export default class LucidePaintbrush extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-paintbrush');
    ...
    path1.setAttribute('d', 'm14.622 17.897-10.68-2.913');
...
customElements.define('lucide-paintbrush', LucidePaintbrush);
