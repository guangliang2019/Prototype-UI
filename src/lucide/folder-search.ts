export default class LucideFolderSearch extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-folder-search');
...
customElements.define('lucide-folder-search', LucideFolderSearch);
