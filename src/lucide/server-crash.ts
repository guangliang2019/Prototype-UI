export default class LucideServerCrash extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-server-crash');
    ...
    path5.setAttribute('d', 'm13 6-4 6h6l-4 6');
    svg.appendChild(path5);

    this.appendChild(svg);
  }
}
customElements.define('lucide-server-crash', LucideServerCrash);
