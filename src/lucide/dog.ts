export default class LucideDog extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-dog');
    ...
    path1.setAttribute('d', 'M11.25 16.25h1.5L12 17z');
    svg.appendChild(path1);

    const path2 = document.createElementNS('http://www.w3.org/2000/svg', 'path');
    path2.setAttribute('d', 'M16 14v.5');
...
customElements.define('lucide-dog', LucideDog);
