export default class LucidePenTool extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-pen-tool');
    ...
    path3.setAttribute('d', 'm2.3 2.3 7.286 7.286');
...
customElements.define('lucide-pen-tool', LucidePenTool);
