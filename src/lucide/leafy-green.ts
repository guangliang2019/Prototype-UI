export default class LucideLeafyGreen extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-leafy-green');
    ...
    path2.setAttribute('d', 'M2 22 17 7');
    svg.appendChild(path2);

    this.appendChild(svg);
  }
}
customElements.define('lucide-leafy-green', LucideLeafyGreen);
