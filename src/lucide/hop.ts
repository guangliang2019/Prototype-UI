export default class LucideHop extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-hop');
    ...
    path7.setAttribute('d', 'M4.93 4.93 3 3a.7.7 0 0 1 0-1');
...
customElements.define('lucide-hop', LucideHop);
