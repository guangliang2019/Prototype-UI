export default class LucideGripHorizontal extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-grip-horizontal');
...
customElements.define('lucide-grip-horizontal', LucideGripHorizontal);
