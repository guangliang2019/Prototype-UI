export default class LucideWallpaper extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-wallpaper');
...
customElements.define('lucide-wallpaper', LucideWallpaper);
