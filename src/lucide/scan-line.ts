export default class LucideScanLine extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-scan-line');
    ...
    path5.setAttribute('d', 'M7 12h10');
    svg.appendChild(path5);

    this.appendChild(svg);
  }
}
customElements.define('lucide-scan-line', LucideScanLine);
