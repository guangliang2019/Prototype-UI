export default class LucideChartBarBig extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-chart-bar-big');
...
customElements.define('lucide-chart-bar-big', LucideChartBarBig);
