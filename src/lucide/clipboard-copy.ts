export default class LucideClipboardCopy extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-clipboard-copy');
...
customElements.define('lucide-clipboard-copy', LucideClipboardCopy);
