export default class LucideSquareDashed extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-square-dashed');
...
customElements.define('lucide-square-dashed', LucideSquareDashed);
