export default class LucideRadiation extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-radiation');
...
customElements.define('lucide-radiation', LucideRadiation);
