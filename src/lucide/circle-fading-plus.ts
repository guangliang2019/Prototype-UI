export default class LucideCircleFadingPlus extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-circle-fading-plus');
...
customElements.define('lucide-circle-fading-plus', LucideCircleFadingPlus);
