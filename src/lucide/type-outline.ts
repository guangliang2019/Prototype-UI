export default class LucideTypeOutline extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-type-outline');
...
customElements.define('lucide-type-outline', LucideTypeOutline);
