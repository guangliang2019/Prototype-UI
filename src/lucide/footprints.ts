export default class LucideFootprints extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-footprints');
    ...
    path3.setAttribute('d', 'M16 17h4');
    svg.appendChild(path3);

    const path4 = document.createElementNS('http://www.w3.org/2000/svg', 'path');
    path4.setAttribute('d', 'M4 13h4');
    svg.appendChild(path4);

    this.appendChild(svg);
  }
}
customElements.define('lucide-footprints', LucideFootprints);
