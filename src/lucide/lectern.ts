export default class LucideLectern extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-lectern');
    ...
    path2.setAttribute('d', 'M18 6V3a1 1 0 0 0-1-1h-3');
...
customElements.define('lucide-lectern', LucideLectern);
