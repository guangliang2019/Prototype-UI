export default class LucideLayoutGrid extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-layout-grid');
...
customElements.define('lucide-layout-grid', LucideLayoutGrid);
