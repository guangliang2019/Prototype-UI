export default class LucideDiamondPlus extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-diamond-plus');
...
customElements.define('lucide-diamond-plus', LucideDiamondPlus);
