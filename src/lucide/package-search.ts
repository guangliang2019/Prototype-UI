export default class LucidePackageSearch extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-package-search');
    ...
    path3.setAttribute('d', 'M20.27 17.27 22 19');
    svg.appendChild(path3);

    this.appendChild(svg);
  }
}
customElements.define('lucide-package-search', LucidePackageSearch);
