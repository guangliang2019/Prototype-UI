export default class LucideFolderOpenDot extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-folder-open-dot');
...
customElements.define('lucide-folder-open-dot', LucideFolderOpenDot);
