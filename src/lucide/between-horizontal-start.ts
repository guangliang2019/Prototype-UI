export default class LucideBetweenHorizontalStart extends HTMLElement {
  connectedCallback() {
    const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.classList.add('lucide', 'lucide-between-horizontal-start');
    ...
    path1.setAttribute('d', 'm2 9 3 3-3 3');
...
customElements.define('lucide-between-horizontal-start', LucideBetweenHorizontalStart);
